...
describe("Shell Completion Backends", function()
  ...
  describe("Script Generation (Thin Shims)", function()
    ...
    it("generates valid Bash completion script", function()
      ...
      assert.truthy(script:find("%-%-__moonstone%-complete bash"), "invokes hidden entrypoint with bash")
    ...
    it("generates valid Fish completion script", function()
      ...
      assert.truthy(script:find("%-%-__moonstone%-complete fish"), "invokes hidden entrypoint with fish")
    ...
    it("generates valid PowerShell completion script", function()
      ...
      assert.truthy(script:find("%-%-__moonstone%-complete powershell"), "invokes hidden entrypoint with powershell")
    end)
